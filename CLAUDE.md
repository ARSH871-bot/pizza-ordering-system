...
- Current working version: `v2.61.0` (local, pending CI). Previous verified baseline: `v2.60.0` (local 495/495).
- Local test run: `497/497` passed, coverage gate passed.
...
- Next task: continue coverage improvements (v2.62.0+).
...
Expected: 497 tests passing. Coverage gate: 75% line-rate on WindowsFormsApplication3 (currently 94.6%+).
